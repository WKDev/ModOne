...
export const timerOffDelaySymbol: SymbolDefinition = {
  ...
  graphics: [
    ...
    { kind: 'polyline', points: [{ x: 21, y: 14 }, { x: 21, y: 26 }, { x: 29, y: 26 }, { x: 29, y: 14 }], stroke: '#888', fill: 'none', strokeWidth: 1 },
    { kind: 'polyline', points: [{ x: 23, y: 16 }, { x: 27, y: 16 }], stroke: '#888', fill: 'none', strokeWidth: 1 },
  ],
  pins: [
