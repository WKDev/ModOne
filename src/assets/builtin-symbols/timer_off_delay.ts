...
export const timerOffDelaySymbol: SymbolDefinition = {
  ...
  graphics: [
    ...
    { kind: 'polyline', points: [{ x: 42, y: 28 }, { x: 42, y: 52 }, { x: 58, y: 52 }, { x: 58, y: 28 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { kind: 'polyline', points: [{ x: 46, y: 32 }, { x: 54, y: 32 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
  ],
  pins: [
