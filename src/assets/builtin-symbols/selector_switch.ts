...
export const selectorSwitchSymbol: SymbolDefinition = {
  ...
  height: 80,
  graphics: [
    { id: 'lead-in', kind: 'polyline', points: [{ x: 0, y: 20 }, { x: 20, y: 20 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { id: 'selector-body', kind: 'circle', cx: 32, cy: 20, r: 10, stroke: '#888', fill: 'transparent', strokeWidth: 2 },
    { id: 'selector-arm', kind: 'polyline', points: [{ x: 32, y: 20 }, { x: 56, y: 12 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { id: 'pos1-lead', kind: 'polyline', points: [{ x: 56, y: 20 }, { x: 80, y: 20 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { id: 'pos2-lead', kind: 'polyline', points: [{ x: 56, y: 40 }, { x: 80, y: 40 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
  ],
  pins: [
