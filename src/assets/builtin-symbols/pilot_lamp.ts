...
export const pilotLampSymbol: SymbolDefinition = {
  ...
  pins: [
    { id: 'in', name: '+', number: '1', type: 'input', shape: 'line', position: { x: 20, y: 0 }, orientation: 'up', length: 0 },
    { id: 'out', name: '-', number: '2', type: 'output', shape: 'line', position: { x: 20, y: 40 }, orientation: 'down', length: 0 },
  ],
  properties: [
