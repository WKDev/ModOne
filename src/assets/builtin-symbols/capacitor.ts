...
export const capacitorSymbol: SymbolDefinition = {
  ...
  graphics: [
    ...
    { kind: 'polyline', points: [{ x: 12, y: 12 }, { x: 12, y: 28 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { kind: 'polyline', points: [{ x: 28, y: 12 }, { x: 28, y: 28 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
