...
export const fuseSymbol: SymbolDefinition = {
  ...
  pins: [
    { id: 'in', name: 'LINE', number: '1', type: 'input', shape: 'line', position: { x: 20, y: 0 }, orientation: 'up', length: 0 },
    { id: 'out', name: 'LOAD', number: '2', type: 'output', shape: 'line', position: { x: 20, y: 50 }, orientation: 'down', length: 0 },
  ],
  properties: [
