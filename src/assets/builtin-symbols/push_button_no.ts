...
export const pushButtonNoSymbol: SymbolDefinition = {
  ...
  graphics: [
    ...
    { kind: 'polyline', points: [{ x: 20, y: 20 }, { x: 42, y: 10 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    ...
    { kind: 'polyline', points: [{ x: 22, y: 6 }, { x: 38, y: 6 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
    { kind: 'polyline', points: [{ x: 30, y: 6 }, { x: 30, y: 14 }], stroke: '#888', fill: 'none', strokeWidth: 2 },
  ],
  pins: [
