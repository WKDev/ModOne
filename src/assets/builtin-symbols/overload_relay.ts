...
export const overloadRelaySymbol: SymbolDefinition = {
  ...
  pins: [
    ...
    { id: 'nc', name: '95-96', number: '95-96', type: 'output', shape: 'line', position: { x: 60, y: 24.5 }, orientation: 'right', length: 0 },
    { id: 'no', name: '97-98', number: '97-98', type: 'output', shape: 'line', position: { x: 60, y: 45.5 }, orientation: 'right', length: 0 },
  ],
  properties: [
