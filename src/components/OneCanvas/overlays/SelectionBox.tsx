...
import type { Position, ContainerPosition } from '../types';
...
export interface SelectionBoxState {
  /** Starting position (Container Space) */
  start: ContainerPosition | Position;
  /** Current/end position (Container Space) */
  end: ContainerPosition | Position;
}
