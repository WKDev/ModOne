/**
 * WireContextMenu Component (Overlay Layer)
 *
 * Context menu that appears when right-clicking on a wire.
 * Renders in Container Space (already provided as screen position).
...
interface WireContextMenuProps {
  /** Screen position to display the menu (Container Space) */
 ...
 *
 * Note: This component already receives Container Space coordinates (screenPosition),
