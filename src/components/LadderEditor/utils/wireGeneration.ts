import type {
  LadderElement, LadderWire, LadderGridConfig, GridPosition,
} from "../../../types/ladder";
 ...
 */
export function generateHorizontalWire(
  startCol: number,
  endCol: number,
  row: number
): WireSegment[] {
 ...
 */
export function connectElementsOnRow(
 ...
 */
export function mapWireSegmentType(type: WireComponentType): LadderWire['type'] {
